              ...
              <table className=" min-w-full divide-y divide-gray-200">
                <thead className="bg-[#1D174D]">
                  <tr>
                    ...
                    <th className="px-8 py-3.5 text-left text-sm font-normal text-white">
                      Assigned to
                    </th>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  <tr>
                    ...
                    <td className="whitespace-nowrap px-12 py-4">
                      <div className="text-sm text-gray-900">9027401</div>
                    </td>
                    <td className="whitespace-nowrap px-12 py-4">
                    ...
                    <td className="whitespace-nowrap px-12 py-4">
                      <div className="text-sm text-gray-900">18/09/16</div>
                    </td>
                    <td className="whitespace-nowrap px-12 py-4">
